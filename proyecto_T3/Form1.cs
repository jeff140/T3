    ...
    public partial class Form1 : Form
    {
        ...
        private void dgvCliente_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                // Cargar Fecha
                if (filaActual.Cells["fecRegCliente"].Value != null &&
                    filaActual.Cells["fecRegCliente"].Value != DBNull.Value)
                {
                    dtpFechaRegistro.Value = Convert.ToDateTime(filaActual.Cells["fecRegCliente"].Value);
        ...
        private async Task BuscarPorDNI(string dni)
        {
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    string url = $"https://dniruc.apisperu.com/api/v1/dni/{dni}?token=YOUR_TOKEN_HERE";
